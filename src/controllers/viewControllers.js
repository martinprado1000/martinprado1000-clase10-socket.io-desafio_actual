// const { ProductManagerFn } = require("../managers/productManager");
// const ProductManager = ProductManagerFn(io)
...
//instacio el manager
const manager = new ProductManager("db/products.json","io0000000000");
